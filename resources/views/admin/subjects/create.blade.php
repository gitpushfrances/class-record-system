                ...
                <div class="p-6">
                    <form action="{{ route('admin.subjects.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" class="w-full px-3 py-2 border rounded" required>
                            @error('code')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="units" value="{{ old('units', 3) }}" min="1" max="10" class="w-full px-3 py-2 border rounded" required>
                            @error('units')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
