                ...
                <div class="p-6">
                    <form action="{{ route('dean.students.update', $student) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="student_number" value="{{ old('student_number', $student->student_number) }}" class="w-full px-3 py-2 font-mono border rounded" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="program" value="{{ old('program', $student->program) }}" placeholder="e.g., BSCS, BSIT" class="w-full px-3 py-2 border rounded">
