...
<div class="max-w-xl mx-auto">
    ...
    <div class="p-6 bg-white border rounded-2xl" style="border-color:#e5e7eb;">
        <form id="subject-form" method="POST" action="{{ route('dean.subjects.store') }}">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block mb-1 text-sm font-semibold text-gray-700">Department <span class="text-red-500">*</span></label>
            ...
            <div class="flex justify-end gap-3 mt-6">
                <a href="{{ route('dean.subjects.index') }}"
